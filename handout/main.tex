...
\begin{align*}
	...
	\beta_{\text{Dia}_j} &= \overline{\beta}_\text{Dia} + z_{\text{Dia}_j}*\sigma_{\text{Dia}}\\
...
\begin{figure}[!h]
\centering
  \includegraphics[width=0.45\linewidth]{../analysis/figs/posterior_diff_dia.png}
...
\begin{center}
	\includegraphics[width=0.70\linewidth]{../analysis/figs/dens_authors.png}
\end{center}
