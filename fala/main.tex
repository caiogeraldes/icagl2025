...
\begin{center}
\includegraphics[width=0.75\linewidth]{../analysis/figs/dag_a.png}
\end{center}
...
\begin{center}
\includegraphics[width=0.75\linewidth]{../analysis/figs/dag_b.png}
\end{center}


\chapter{Intermezzo: Authors and dialects}\label{chap:intermezzo_authors_and_dialects} % (fold)
...
\begin{center}
\includegraphics[width=0.75\linewidth]{../analysis/figs/dag_c.png}
\end{center}
...
\begin{center}
\includegraphics[width=0.75\linewidth]{../analysis/figs/dag_d.png}
\end{center}


% chapter The target of attraction (end)

\chapter{Analysis}\label{chap:analysis} % (fold)
...
The following generalize linear model allows us to do so:
...
\begin{align*}
	...
	\beta_{\text{Dist}}\text{Dist}_i + \beta_{\text{WO}} \text{Prec}_i \\&+
		\beta_{\text{PoS}}\sum^{PoS_i-1}_{j=0}{\delta_j_{\text{PoS}}} + \beta_{\text{Th}}\sum^{Th_i-1}_{j=0}{\delta_j_{\text{Th}}} \\&+
	...
	\beta_{\text{Auth}_j} &\sim \text{Normal}(\overline{\beta}_{\text{Auth}},
	\sigma_{\text{Auth}})\\
	\beta_{\text{Dia}_j} &\sim \text{Normal}(\overline{\beta}_{\text{Dia}}, \sigma_{\text{Dia}})\\
	\overline{\beta}_{\text{Auth}}, \overline{\beta}_{\text{Dia}} &\sim \text{Normal}(0, 1)\\
...
%   \centering
%   \includegraphics[width=\linewidth]{../analysis/figs/dag_cop.png}
...
% \begin{minipage}{.45\textwidth}
%   \centering
%   \includegraphics[width=\linewidth]{../analysis/figs/dag_pos.png}
...
$\beta_{\text{PoS}}$ is the general effect of the part of speech over the likelihood of
Attraction, and $\delta$ is a vector with values
...
\begin{center}
	\includegraphics[width=0.75\linewidth]{../analysis/figs/model_domain_banddelta.png}
\end{center}
...
\begin{center}
	\input{../analysis/tables/model_author_effects.tex}
